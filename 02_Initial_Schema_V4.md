...
-- ⚠️ CÓPIA POTENCIALMENTE DESATUALIZADA — a fonte canônica é schemas/02_Initial_Schema_V4.sql
-- (que já contém a seção 4.B VECTOR INTELLIGENCE & RAG PIPELINE V5.0 ausente aqui).
...
-- compilation_target arquitetural "V4 = Governanca/Hybrid", independente da versao do Kernel Prisma.)
